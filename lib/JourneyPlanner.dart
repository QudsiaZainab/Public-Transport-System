...
class _JourneyPlannerState extends State<JourneyPlanner> {
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: isButtonEnabled
                ...
                // Use fromLocation, toLocation, and selectedTransport
                // Update UI with journey results
              }
  ...
  Widget _buildSelectableTag(
    ...
    isSelected ? Colors.grey[400] : Colors.grey[200];
      ...
      appBar: AppBar(
        ...
        title: TextField(
          ...
          decoration: InputDecoration(
            ...
            hintStyle: TextStyle(
                color: Colors
                    .white), // Set placeholder color to white
